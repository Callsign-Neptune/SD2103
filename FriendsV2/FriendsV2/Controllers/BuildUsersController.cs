...
namespace FriendsV2.Controllers
{
    public class BuildUsersController : Controller
    {
        ...
        public BuildUsersController(MinecraftV2Context context, UserManager<IdentityUser> userManager, IHostingEnvironment webroot )
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Displayname,Firstname,Lastname,Bio,UserAccountId,PhotoPath")] BuildUser buildUser, IFormFile FilePhoto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Displayname,Firstname,Lastname,Bio,UserAccountId,PhotoPath")] BuildUser buildUser, IFormFile FilePhoto)
        {
